        ...
        {intervention && (
          <section className="rounded-2xl border border-fuchsia-500/30 bg-fuchsia-500/5 p-6 sm:p-8 shadow-lg">
            ...
            {intervention.available ? (
              ...
              <div className="ml-11 rounded-xl border border-gray-500/20 bg-gray-500/10 p-4">
                <p className="text-sm text-gray-400">A targeted explanation hasn&apos;t been configured for this concept yet.</p>
              </div>
            )}
          </section>
        )}
