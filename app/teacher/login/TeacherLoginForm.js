...
export default function TeacherLoginForm() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      // Server set the cookie — navigate to dashboard.
  ...
  return (
    <form onSubmit={handleSubmit} noValidate className="space-y-4">
      ...
      {/* Email */}
      <div>
        <label htmlFor="teacher-email" className="block text-sm font-medium text-gray-300 mb-1.5">
          Email address
        </label>
        <input
          id="teacher-email"
      ...
      {/* Password */}
      <div>
        <label htmlFor="teacher-password" className="block text-sm font-medium text-gray-300 mb-1.5">
          Password
        </label>
        <input
          id="teacher-password"
      ...
      >
        {loading ? (
          <>
            {/* Spinner — CSS-only, no animation library */}
            <svg
